...
// Демо-пример текста программы (не часть SPEC.md — для быстрого прохода жюри: «Заполнить
// демо-данными» → «Сгенерировать» → черновик открыт, без ручного ввода). Разумное описание
// программы господдержки МСБ — не отраслевой пример, чтобы не привязываться к конкретному
// уже используемому в стенде сценарию.
const DEMO_GENERATE_TEXT = `Программа субсидирования процентной ставки для малого и среднего бизнеса.
Заявитель — действующее ИП или ТОО (БИН, например 990101400000), зарегистрированное на территории Республики Казахстан и работающее не менее 6 месяцев.
Направление — производство, переработка или услуги; приоритет отдаётся несырьевым отраслям.
Условия: субсидируется часть ставки вознаграждения по кредиту банка-партнёра — до 7% годовых, на срок не более 36 месяцев, сумма кредита — до 500 000 000 тенге.
Цель кредита — пополнение оборотных средств, приобретение оборудования или расширение действующего производства.
Перечень документов: заявление по установленной форме, копия свидетельства о государственной регистрации, справка об отсутствии налоговой задолженности, бизнес-план, кредитный договор с банком-партнёром.
Результат оказания услуги — решение о субсидировании либо мотивированный отказ; срок рассмотрения — 15 рабочих дней.`;
